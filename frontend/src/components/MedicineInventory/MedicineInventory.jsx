      ...
      <div style={{ maxHeight: "60vh", overflowY: "auto", borderRadius: "10px", border: "1px solid #eee" }}>
        <table className="table align-middle" style={{ minWidth: "950px", marginBottom: 0 }}>
          ...
          <tbody>
            ...
            <tr>
              <td><input type="checkbox" /></td>
              <td><strong>Amoxicillin 250 mg</strong><br /><small className="text-secondary">AMKDE2014</small></td>
              <td>Tablet</td>
              <td>₹40.55</td>
              <td>28 pcs</td>
              <td>2023-07-21</td>
            ...
            <tr>
              <td><input type="checkbox" /></td>
              <td><strong>Aspirin 300 mg</strong><br /><small className="text-secondary">ASPKDE0090</small></td>
              <td>Tablet</td>
              <td>₹28.55</td>
              <td>190 pcs</td>
              <td>2024-06-01</td>
            ...
            <tr>
              <td><input type="checkbox" /></td>
              <td><strong>Benadryl 500 ml</strong><br /><small className="text-secondary">SYPCBE00112</small></td>
              <td>Syrup</td>
              <td>₹77.65</td>
              <td>80 pcs</td>
              <td>2025-01-01</td>
            ...
            <tr>
              <td><input type="checkbox" /></td>
              <td><strong>Bufexamac 100 g</strong><br /><small className="text-secondary">CRMXCE00123</small></td>
              <td>Cream</td>
              <td>70.55</td>
              <td>100 pcs</td>
              <td>2024-11-01</td>
